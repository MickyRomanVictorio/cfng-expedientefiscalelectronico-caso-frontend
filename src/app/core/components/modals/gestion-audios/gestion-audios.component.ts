...
import { SubirAudioComponent } from "@components/modals/gestion-audios/subir-audio/subir-audio.component"
...
@Component({
  ...
  templateUrl: './gestion-audios.component.html',
  styleUrl: './gestion-audios.component.scss',
  encapsulation: ViewEncapsulation.None
})
export class GestionAudiosComponent implements OnInit, OnDestroy {
  ...
  protected tituloModal?: SafeHtml
  ...
  @ViewChild(SubirAudioComponent) fileComponent?: SubirAudioComponent
  ...
  ngOnInit(): void {
    ...
    this.suscripciones.push(
      this.reusableGestionarAudioService.seEstaReproduciendoObservable.subscribe({
        next: reproduciendo => {
          this.reproduciendoAudio = reproduciendo
        }
      })
    )
  }
  ...
  private initializePropertiesFromConfig(): void {
    ...
    this.tituloModal = this.config.data?.tituloModal

...
import { ResponderObservarCasoElevadoModalComponent } from '@components/modals/responder-observar-casos-elevados-modal/responder-observar-casos-elevados-modal.component';
...
@Component({
  standalone: true,
  selector: 'app-responder-contiendas-superior',
  templateUrl: './responder-contiendas-superior.component.html',
  styleUrls: ['./responder-contiendas-superior.component.scss'],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
...
export class ResponderContiendasSuperiorComponent implements OnInit {

...
@Component({
  selector: 'app-listar-contiendas',
  templateUrl: './listar-contiendas.component.html',
  styleUrls: ['./listar-contiendas.component.scss'],
  standalone: true,
  imports: [
    CalendarModule,
    CheckboxModule,
...
export class ListarContiendasComponent implements OnInit {

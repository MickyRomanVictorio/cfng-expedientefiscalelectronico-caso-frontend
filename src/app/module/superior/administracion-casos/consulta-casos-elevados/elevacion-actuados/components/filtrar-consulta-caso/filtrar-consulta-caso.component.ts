...
export class FiltrarConsultaCasoComponent implements OnInit{
  ...
  constructor(
    ...
    this.plazos =this.consultaCasosGestionService.getLeyendaPlazos().filter(leyenda => leyenda.codigo !== '4').map(leyenda => ({label:leyenda.nombre, value:leyenda.codigo})); // Excluir el plazo "Sin plazo"
  }

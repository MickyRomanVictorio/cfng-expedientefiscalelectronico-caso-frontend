...
import { ApelacionesAutoComponent } from './apelaciones-auto.component';

describe('ListarConsultaCasosComponent', () => {
  let component: ApelacionesAutoComponent;
  let fixture: ComponentFixture<ApelacionesAutoComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(ApelacionesAutoComponent);

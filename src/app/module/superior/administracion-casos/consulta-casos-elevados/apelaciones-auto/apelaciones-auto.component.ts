...
@Component({
  ...
  templateUrl: './apelaciones-auto.component.html',
  styleUrl: './apelaciones-auto.component.scss',
  imports: [
    PanelModule,
    ButtonModule,
    NgClass,
...
export class ApelacionesAutoComponent implements OnInit {
  ...
  private obtenerDatos(datos:any){
    this.casosElevadosService.obtenerCasosApelacionesAuto(datos).subscribe({
      next: (rs) => {

...
@Component({
  selector: 'app-carpeta-caso-extremo',
  standalone: true,
  imports: [
    NgClass,
  ...
  templateUrl: './carpeta-caso-extremo.component.html',
  styleUrl: './carpeta-caso-extremo.component.scss',
  providers: [DatePipe, DialogService],
})
export class CarpetaCasoExtremoComponent {

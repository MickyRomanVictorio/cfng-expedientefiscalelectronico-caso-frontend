...
@Component({
  standalone: true,
  selector: 'app-consulta-casos-elevados-exclusion-fiscal',
...
export class ExclusionFiscalCasoElevadoComponent implements OnInit {
  ...
  private obtenerDatos(datos:any){
    this.casosElevadosService.obtenerCasos(TipoElevacionCodigo.ExclusionFiscal, datos).subscribe({
      next: (rs) => {

...
import { of } from 'rxjs';
import { CasosObservadosComponent } from './casos-observados.component';


describe('ElevacionActuadosComponent', () => {

  let component: any;
  let fixture: ComponentFixture<CasosObservadosComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(CasosObservadosComponent);

...
@Component({
  ...
  templateUrl:
    './subsanar-disposicion-emitir-pronunciamiento-superior.component.html',

})
export class SubsanarDisposicionEmitirPronunciamientoSuperiorComponent  implements OnInit{
  ...
  protected flagEfe: boolean = false;
      ...
      (respuesta: any) => {
        if (respuesta.esFirmado) {
          ...
          const request: AlertaGeneralRequestDTO = {
            ...
            codigoAlertaTramite: CodigoAlertaTramiteEnum.AL_SUP_PRON_CONT2,

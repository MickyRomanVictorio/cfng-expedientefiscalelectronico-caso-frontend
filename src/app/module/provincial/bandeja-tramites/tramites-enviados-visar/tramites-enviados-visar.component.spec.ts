...
import TramitesEnviadosVisarComponent from './tramites-enviados-visar.component';

describe('TramitesEnviadosVisarComponent', () => {
  let component: TramitesEnviadosVisarComponent;
  let fixture: ComponentFixture<TramitesEnviadosVisarComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [TramitesEnviadosVisarComponent],
      providers: [JwtHelperService, provideHttpClient()],
    }).compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(TramitesEnviadosVisarComponent);

...
@Component({
  standalone: true,
  selector: 'app-tramites-pendientes-revisar-filtro',
  templateUrl: './tramites-pendientes-revisar-filtro.component.html',
  imports: [
    CalendarModule,
    CmpLibModule,
    DateMaskModule,
...
export default class TramitesPendientesRevisarFiltroComponent implements OnInit, OnDestroy {
  ...
  protected buscarTramite(): void {
    ...
    const request: BandejaTramiteRequest = {
      ...
      idEstadoBandeja: BANDEJA_ESTADO.TRAMITES_PENDIENTES_REVISAR,
      idEtapa: form.etapa ?? '',

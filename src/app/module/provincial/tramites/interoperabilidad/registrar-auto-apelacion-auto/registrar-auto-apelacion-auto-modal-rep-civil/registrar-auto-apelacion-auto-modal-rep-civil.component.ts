...
@Component({
  standalone: true,
  selector: 'app-registrar-auto-apelacion-auto-modal-rep-civil',
  templateUrl: './registrar-auto-apelacion-auto-modal-rep-civil.component.html',
  styleUrls: ['./registrar-auto-apelacion-auto-modal-rep-civil.component.scss'],
  imports: [
    CmpLibModule,
    NgIf,
    ProgressBarModule,
...
export class RegistrarAutoApelacionAutoModalRepCivilComponent implements OnInit {
  ...
  private obtenerSujetosProcesales(): void {
    ...
    this.subscriptions.push(
      this.pestanaApelacionSujetoService
        .obtenerSujetosProcesalesSalidaExterna(this.idActoTramiteCaso)
        .subscribe({
          next: (resp) => {

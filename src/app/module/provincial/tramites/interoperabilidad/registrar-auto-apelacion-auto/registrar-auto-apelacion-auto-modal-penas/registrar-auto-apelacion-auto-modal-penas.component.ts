...
@Component({
  standalone: true,
  selector: 'app-registrar-auto-apelacion-auto-modal-penasl',
  templateUrl: './registrar-auto-apelacion-auto-modal-penas.component.html',
  styleUrls: ['./registrar-auto-apelacion-auto-modal-penas.component.scss'],
  imports: [
    CmpLibModule,
    NgIf,
    ProgressBarModule,
...
export class RegistrarAutoApelacionAutoModalPenasComponent implements OnInit {
  ...
  private obtenerSujetosProcesales(): void {
    ...
    this.subscriptions.push(
      this.pestanaApelacionSujetoService
        .obtenerSujetosProcesalesPena(this.idActoTramiteCaso)
        .subscribe({
          next: (resp) => {

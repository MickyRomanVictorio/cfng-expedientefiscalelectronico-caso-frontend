...
@Component({
  ...
  templateUrl: './subsanar-auto-resuelve-apelacion-sentencia.component.html',
  styleUrl: './subsanar-auto-resuelve-apelacion-sentencia.component.scss',
  imports: [
    RadioButtonModule,
    DateMaskModule,
    DropdownModule,
...
export class SubsanarAutoResuelveApelacionSentenciaComponent implements OnInit, OnDestroy {
  ...
  longitudMaximaObservaciones = 200;
  ...
  protected formularioAutoResuelve: FormGroup = new FormGroup({
    ...
    nombreFiscaliaProvincial: new FormControl(null),
  ...
  numeroCaso: any;
  nuPestana: any;
  tramiteEnModoEdicion: any;
  flCheckModal: any;
  suscripciones: any;
  nombreFiscaliaProvincial: any;
  observacionProvincial: any;
  datosPronunciamiento: any;
  esPosibleEditarFormulario: any;
  ...
  private resetearFormulario(): void {
    ...
    this.formRegistro.get('fechaNotificacion')!.disable()
  ...
  async procesoFirma(realizado: string): Promise<void> {
    if (realizado === '0') {
      ...
      const requestCargo: any = {
        ...
        fechaNotificacion: formCargo.fechaNotificacion,
      ...
      this.pestanaApelacionService
        ...
        .subscribe({
          next: (data) => {
            ...
            this.datosPronunciamiento!.fiscalPronuncimiento = data.nombreFiscalProvincial;
            this.datosPronunciamiento!.nombreFiscalia = data.nombreFiscaliaProvincial;
          },
          error: (error) => {
            console.log(error);
          },

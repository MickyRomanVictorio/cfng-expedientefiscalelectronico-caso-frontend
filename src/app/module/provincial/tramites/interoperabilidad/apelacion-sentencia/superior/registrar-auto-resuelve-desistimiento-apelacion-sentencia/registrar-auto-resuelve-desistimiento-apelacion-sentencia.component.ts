...
@Component({
  ...
  templateUrl: './registrar-auto-resuelve-desistimiento-apelacion-sentencia.component.html',
  styleUrls: ['./registrar-auto-resuelve-desistimiento-apelacion-sentencia.component.scss'],
  imports: [
    NgClass,
    FormsModule,
    ReactiveFormsModule,
...
export class RegistrarAutoResuelveDesistimientoApelacionSentenciaComponent implements OnInit, OnDestroy {
  @Input() idCaso: string = '';
  ...
  ngOnInit(): void {
    ...
    console.log('this.codJerarquia', this.codJerarquia);
          ...
          columnas: [
            {
              ...
              nombre_campo: 'idResultadoResuelveDesistimiento',
              mostrar_campo: 'flResultadoResuelveDesistimientoMostrar',
              mostrar: true,
              editar: true
            }
          ]

...
@Component({
  selector: 'app-resuelve-consentido-queja-sentencia',
  standalone: true,
  templateUrl: './auto-resuelve-consentido-queja.component.html',
  imports: [
    MessagesModule,
    CalendarModule,
    DateMaskModule,
  ...
  styleUrls: ['./auto-resuelve-consentido-queja.component.scss'],
})
export class AppResuelveConsentidoQuejaSentenciaComponent implements OnInit {
  @Input() idCaso: string = '';

...
import { ConsentidoFormularioBaseComponent } from "../consentido-components/formulario-consentido/consentido-formulario-base.component";
import { RegistrarConsentidoModalComponent } from '../consentido-components/modal-consentido/registrar-consentido-modal.component';

@Component({
  selector: 'app-resuelve-consentido-apelacion-sentencia',
  standalone: true,
  templateUrl: './auto-resuelve-consentido-apelacion.component.html',
  imports: [
    MessagesModule,
    CalendarModule,
    DateMaskModule,
    ...
    InputTextareaModule,
    NgxCfngCoreModalDialogModule,
    ConsentidoFormularioBaseComponent
],
  providers: [DialogService, MensajeNotificacionService],
  styleUrls: ['./auto-resuelve-consentido-apelacion.component.scss'],
})
export class AppResuelveConsentidoApelacionSentenciaComponent implements OnInit {
  @Input() idCaso: string = '';
...
protected flCheckModal: boolean = false;
  ...
  public openModalSujetos(): void {
    const ref = this.dialogService.open(
     // SentenciaApeConAutoModalComponent,
     RegistrarConsentidoModalComponent,
      {
        showHeader: false,
        data: {
          tipo:'apelacion',

...
import { SentenciaApelacionModalComponent } from './sujetos-apelacion-modal/sujetos-apelacion-modal.component';
...
@Component({
  ...
  selector: 'app-recurso-apelacion-sentencia',
  templateUrl: './recurso-apelacion-sentencia.component.html',
  styleUrls: ['./recurso-apelacion-sentencia.component.scss'],
  providers: [DialogService, DatePipe]
})

export class AppRecursoApelacionSentenciaComponent implements OnInit, OnDestroy {
  @Input() idCaso: string = '';
...
private sujetosProcesalesEnviar: any[] = [];
 ...
 protected habilitarGuardar(estado: boolean): void {
  ...
  public openModalSujetos(): void {
    const ref = this.dialogService.open(SentenciaApelacionModalComponent, {
      showHeader: false,
      data: {

...
@Component({
  selector: 'app-solicitud-acuerdo-reparatorio',
  standalone: true,
  imports: [
    CommonModule,
    ButtonModule,
  ...
  templateUrl: './solicitud-acuerdo-reparatorio.component.html',
  styleUrls: ['./solicitud-acuerdo-reparatorio.component.scss']
})
export class SolicitudAcuerdoReparatorioComponent implements OnInit {

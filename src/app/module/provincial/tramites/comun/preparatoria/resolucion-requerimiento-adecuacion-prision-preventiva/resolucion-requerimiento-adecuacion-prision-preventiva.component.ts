...
import { ResultadoAudienciaPrisionPreventivaComponent } from '@modules/provincial/tramites/interoperabilidad/registrar-auto-resuelve-requerimiento-prision-preventiva/resultado-audiencia-prision-preventiva/resultado-audiencia-prision-preventiva.component';

@Component({
  selector: 'app-resolucion-requerimiento-adecuacion-prision-preventiva',
  standalone: true,
  imports: [
        FormsModule,
        ReactiveFormsModule,
  ...
  templateUrl: './resolucion-requerimiento-adecuacion-prision-preventiva.component.html',
  styleUrl: './resolucion-requerimiento-adecuacion-prision-preventiva.component.scss'
})
export class ResolucionRequerimientoAdecuacionPrisionPreventivaComponent implements OnInit, OnDestroy {
  @Input() idCaso: string = '';

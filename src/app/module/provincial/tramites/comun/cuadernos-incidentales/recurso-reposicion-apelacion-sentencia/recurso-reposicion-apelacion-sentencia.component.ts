...
@Component({
  ...
  templateUrl: './recurso-reposicion-apelacion-sentencia.component.html',
  styleUrls: ['./recurso-reposicion-apelacion-sentencia.component.scss'],
  providers: [DialogService, DatePipe]
})

export class RecursoReposicionApelacionSentenciaComponent implements OnInit, OnDestroy {
  @Input() idCaso: string = '';
  ...
  public openModalSujetos(): void {
    let dataModal = {
      ...
      data: {
        ...
        configuracion: {
          titulo: 'Seleccionar recurso de reposición de apelación de sentencia',
          subtitulo: 'Seleccione los sujetos procesales a los que registrará el recurso de reposición de apelación de sentencia:',
          mensaje_informativo: {
            mostrar: false,
            descripcion: null,
          ...
          columnas: [
            {
              ...
              nombre_campo: 'checkResultadoRecursoReposicionSeleccionar',
              mostrar_campo: 'checkResultadoRecursoReposicionMostrar',
              mostrar: true,
              editar: true
            }
          ]

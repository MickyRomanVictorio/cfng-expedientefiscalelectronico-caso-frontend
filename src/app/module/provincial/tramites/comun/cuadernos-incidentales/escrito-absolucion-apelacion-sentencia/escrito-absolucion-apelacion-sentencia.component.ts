...
@Component({
  ...
  templateUrl: './escrito-absolucion-apelacion-sentencia.component.html',
  styleUrls: ['./escrito-absolucion-apelacion-sentencia.component.scss'],
  providers: [DialogService, DatePipe]
})

export class EscritoAbsolucionApelacionSentenciaComponent implements OnInit, OnDestroy {
  @Input() idCaso: string = '';
  ...
  public openModalSujetos(): void {
    let dataModal = {
      ...
      data: {
        ...
        configuracion: {
          titulo: 'Seleccionar escrito de absolución de apelación de sentencia',
          subtitulo: 'Seleccione los sujetos procesales a los que registrará la absolución de apelación de sentencia',
          mensaje_informativo: {
            mostrar: false,
            descripcion: null,
          ...
          columnas: [
            {
              nombre_campo: 'checkResultadoRecursoAbsolucionSeleccionar',
              mostrar_campo: 'checkResultadoRecursoAbsolucionMostrar',
              mostrar: true,
              editar: true
            }
          ]

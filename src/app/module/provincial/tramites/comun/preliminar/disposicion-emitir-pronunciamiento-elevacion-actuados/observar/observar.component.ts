...
export class ObservarComponent implements OnInit {
  ...
  public minCaracteres = model<number>(10);
  ...
  constructor(
    ...
    if (this.config) {
      ...
      if (this.config.data.minCaracteres) {
        this.minCaracteres.set(this.config.data.minCaracteres);
      }
    }
  }
  ...
  ngOnInit(): void {
    this.formulario = this.formBuilder.group({
      ...
      }, [ Validators.required, Validators.minLength(this.minCaracteres()), Validators.maxLength(1000) ] ],
    });
  }

...
import { DesagregarCasoComponent } from '@modules/provincial/tramites/comun/preliminar/desagregar-caso/desagregar-caso.component';
import { DesagregacionCasoComponent } from '../../desagregacion-caso/desagregacion-caso.component';
...
export class EtiquetaAccionesCasoComponent {
  ...
  ngOnInit(): void {
    ...
    console.log("🚀 ~ EtiquetaAccionesCasoComponent ~ ngOnInit ~ this.idJerarquia:", this.idJerarquia)
  }

...
export const DOMAIN_BACK_LOCAL = 'http://localhost:8089';
export const DOMAIN_BACK_LOCAL_TRAMITES = 'http://localhost:8086';
...
export const DOMAIN_BACK_LOCAL_DERIVACION = 'http://localhost:8084';
export const DOMAIN_BACK_LOCAL_MAESTROS = 'http://10.40.121.11:8090';
export const DOMAIN_BACK_LOCAL_MAESTROS2 = 'http://localhost:8090';
export const DOMAIN_BACK_MESA_DOCUMENTOS = 'http://localhost:8093';
export const DOMAIN_BACK_LOCAL_SAD = 'http://10.40.121.11:8096';
export const DOMAIN_FRONT = 'http://localhost:4200';
export const DOMAIN_AUTH = 'http://26.115.181.4:8087';
...
//export const DOMAIN_ASSETS = 'http://26.115.181.4:8088/assets';
export const DOMAIN_ASSETS = 'http://172.16.111.112:8085/assets'; //correcto
...
export const BACKEND = {
  ...
  //CFEEXPEDIENTE: `${DOMAIN_BACK_LOCAL}/cfe/expedientefiscalelectronico/`,
  ...
  //CFE_EFE_ALERTAS: `http://localhost:8080/cfe/expedientefiscalelectronico/alertas`,
  ...
  // CFEMAESTROS: `${DOMAIN_BACK_LOCAL_MAESTROS2}/cfe/generales/maestro/`,
  ...
  CFETOKEN: `http://cfms-sad-administracion-gestion-api-development.apps.dev.ocp4.cfe.mpfn.gob.pe:8888/cfe/sad/administracion/v1/e/sesion/tokenSesion-new`,
  //CFETOKEN: `${DOMAIN_AUTH}/cfetoken/resources/v2/loginToken`,

  /*MESA UNICA-DESPACHO*/
  MESA_UNICA_DESPACHO: `http://cfms-mesadepartes-unicadespacho-gestion-api-development.${DOMAIN}/cfe/mesadepartes/unicadespacho/`,
  ...
  REPOSITORIO_DOCUMENTO_PRIVADO: `http://cfms-generales-almacenamiento-objetos-api-development.apps.dev.ocp4.cfe.mpfn.gob.pe/cfe/generales/objetos/v2/t/almacenamiento/privado`,
  ...
  //CFEAPLICACIONES: `${DOMAIN_BACK_LOCAL_SAD}/cfe/sad/administracion/v1/e/usuario/listarAplicaciones/`,
  ...
  //CFEOPCIONES: `${DOMAIN_BACK_LOCAL_SAD}/cfe/sad/administracion/v1/e/usuario/listarOpcionesByUsuarioApliacion/`,
};
